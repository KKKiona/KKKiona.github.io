...
$("<link>").attr({href: live2d_path + "D:/blog/live2d-widget/waifu.css", rel: "stylesheet", type: "text/css"}).appendTo("head");
//waifu.css的绝对路径

$.ajax({
	url: live2d_path + "D:/blog/live2d-widget/live2d.min.js",
	dataType: "script",
	cache: true,
	async: false
});
...
$.ajax({
	url: live2d_path + "D:/blog/live2d-widget/waifu-tips.js",
	dataType: "script",
	cache: true,
	async: false
});
...
$(window).on("load", function() {
	initWidget(live2d_path + "D:/blog/live2d-widget/waifu-tips.json", "https://live2d.fghrsh.net/api");
});
